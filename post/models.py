...
class Post(models.Model):
	...
	video=models.FileField(upload_to=user_directory_path,verbose_name='video',null=False,)
	...
	num_saves = models.PositiveIntegerField(default=0)
	...
	def __str__(self):
		return str(self.caption[:12])

	def save(self, *args, **kwargs):
			self.num_saves = self.saved_by.count()
